...
const step1CategorySkillsSchema = z.object({
  ...
  bio: z.string().min(50, "Bio must be at least 50 characters.").max(1000, "Bio cannot exceed 1000 characters.").optional().or(z.literal('')),
});
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea
                    placeholder="Tell customers a bit about yourself, your experience, and what makes your service great..."
                    rows={5}
                    {...field}
                    disabled={isSaving}
                  />
