    ...
    <FormItem>
      ...
      <div className={`relative w-full ${aspectRatio || 'aspect-video'} rounded-md border border-dashed bg-muted/30 flex items-center justify-center`}>
        {isValidImageSrc(fileState.previewUrl) ? (
          <NextImage src={fileState.previewUrl} alt={`${label} preview`} fill className="object-contain p-1" unoptimized={fileState.previewUrl.startsWith('blob:')} sizes="(max-width: 640px) 100vw, 50vw"/>
        ) : (
