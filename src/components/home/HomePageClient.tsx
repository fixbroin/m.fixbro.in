...
export default function HomePageClient({ citySlug, areaSlug, breadcrumbItems }: HomePageClientProps) {
  ...
  const fetchPageSpecificData = useCallback(async () => {
    ...
    setIsLoadingPageData(true);
      ...
      const defaultOgImage = (process.env.NEXT_PUBLIC_BASE_URL || 'https://m.fixbro.in') + '/android-chrome-512x512.png';
      ...
      const pageUrl = process.env.NEXT_PUBLIC_BASE_URL || 'https://m.fixbro.in';
        ...
        <section className="py-8 md:py-12 text-center bg-primary text-primary-foreground">
          <div className="container mx-auto px-4">
            ...
            <p className="text-lg mb-6 max-w-xl mx-auto">
              Browse local professionals, check their profiles, and connect directly to get the job done.
            </p>
            <Button
              size="lg"
              variant="secondary"
