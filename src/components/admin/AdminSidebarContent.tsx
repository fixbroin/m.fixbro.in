...
import { LayoutGrid, List, Layers, Settings, Users, ShoppingBag, Tag, BarChart3, PlaySquare, Settings2, HelpCircle, MessageSquare, ListChecks, Percent, UserCircle as UserProfileIcon, Target, Map, Handshake, Megaphone, Bell, Activity, Palette, MessageSquare as ChatIcon, Mail, Zap, Receipt, Tv, Users2, MapPin, Cookie, Globe2, KeyRound, Database, FileText, Construction, Banknote, ShieldAlert, HandCoins } from 'lucide-react';
...
const navItems = [
  ...
  { type: 'separator', label: 'Finance & Monetization' },
...
export default function AdminSidebarContent() {
  ...
  const uniqueTopLevelAdminPages = [
    ...
    '/admin/complaints', // Added new page
    '/admin/connections', // Added new page
  ];
