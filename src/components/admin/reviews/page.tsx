...
export default function AdminReviewsPage() {
  ...
  const [providers, setProviders] = useState<ProviderApplication[]>([]); // Added providers
  ...
  const handleFormSubmit = async (data: ReviewFormData & { serviceName?: string, providerId: string, adminCreated: boolean, id?: string }) => {
    setIsSubmitting(true);
