  ...
  const handleGenerateSeo = async () => {
    ...
    if (!categoryName || categoryName.trim() === "") {
        toast({
            ...
            description: "Please enter a category name before generating SEO content.",
            variant: "destructive",
        });
        return;
    }
    ...
    try {
        ...
        form.setValue("seo_description", result.meta_description, { shouldValidate: true });
        form.setValue("seo_keywords", result.meta_keywords, { shouldValidate: true });
