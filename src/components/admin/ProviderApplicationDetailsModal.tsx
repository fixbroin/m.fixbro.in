      ...
      <DialogContent className="max-w-3xl w-[90vw] max-h-[90vh] flex flex-col p-0">
        ...
        <div className="flex-grow overflow-y-auto min-h-0">
            ...
            <Tabs defaultValue="personal">
                ...
                <TabsTrigger value="location"><MapPin className="mr-1 h-4 w-4"/>Location</TabsTrigger>
                ...
                <TabsContent value="personal" className="space-y-3 text-sm">
                    ...
                    <div>
                      <p className="font-semibold">Bio / About Me:</p>
                      <p className="text-sm text-muted-foreground whitespace-pre-wrap mt-1">{application.bio || 'N/A'}</p>
                    </div>
                </TabsContent>
                ...
                <TabsContent value="location" className="space-y-4 text-sm">
                    <div>
                        <h4 className="font-semibold mb-1">Work Area Center</h4>
                        <p><strong>Coordinates:</strong> {application.workAreaCenter ? `${application.workAreaCenter.latitude.toFixed(4)}, ${application.workAreaCenter.longitude.toFixed(4)}` : 'N/A'}</p>
                ...
                <TabsContent value="confirmation" className="space-y-4 text-sm">
                    <div>
                        <h4 className="font-semibold mb-1">Terms & Conditions Agreement</h4>
        ...
        <DialogFooter className="p-4 sm:p-6 border-t flex-shrink-0 flex flex-col sm:flex-row gap-2">
