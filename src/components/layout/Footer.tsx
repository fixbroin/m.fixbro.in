...
const Footer = () => {
  ...
  const websiteName = settings?.websiteName || process.env.NEXT_PUBLIC_WEBSITE_NAME || "Fixbro";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          <div className="col-span-1 lg:col-span-1">
            ...
            <p className="mt-4 text-sm">
              Your direct connection to local, verified home service professionals.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><FooterLink href="/terms-of-service">Terms and Conditions</FooterLink></li>
              <li><FooterLink href="/privacy-policy">Privacy Policy</FooterLink></li>
              <li><FooterLink href="/provider-terms-conditions">Provider Terms & Conditions</FooterLink></li>
