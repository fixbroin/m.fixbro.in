...
import { Search, Bell, Menu, X, ShoppingCart, LogOut, UserCircle, Briefcase, Settings2, Moon, Sun, MessageSquare, UserPlus, MapPin, Construction, Handshake, Users } from 'lucide-react';
...
const Header = ({ onLocationClick }: { onLocationClick: () => void; }) => {
  ...
  const userSpecificNavItems = [
    ...
    { href: '/my-bookings', label: 'My Contacts', icon: Users, isProtected: true },
      ...
      <header className="bg-background/80 backdrop-blur-md shadow-sm sticky top-0 z-50 border-b">
        <div data-hydration-state="hydrated" className="container mx-auto px-4 h-16 grid grid-cols-2 md:grid-cols-header-layout items-center">
          ...
          <div className="flex items-center justify-end gap-1 md:gap-2">
            ...
            <Button variant="ghost" size="icon" onClick={onLocationClick} aria-label="Set Location">
