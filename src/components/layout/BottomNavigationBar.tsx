...
import { Home, Layers, Briefcase, UserCircle as UserIcon, Construction, Handshake, Users } from 'lucide-react';
...
const BottomNavigationBar = () => {
  ...
  const navItems: NavItem[] = [
    ...
    { href: '/my-bookings', label: 'Contacts', icon: Users, isProtected: true },
