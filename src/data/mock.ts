...
import { Car, Droplets, Home, PaintRoller, PlugZap, ShieldCheck, Sparkles, Star, Users, Utensils, Wrench, ClockIcon, Layers, ShoppingBag as ServiceIconLucide, AirVent, Refrigerator, Handshake, MapPin, IndianRupee } from 'lucide-react';
...
export const whyChooseUsItems = [
  { id: 'wc1', title: 'Direct Connection', icon: Handshake, description: 'Connect directly with local professionals, no middlemen involved.' },
  { id: 'wc2', title: 'Verified Providers', icon: ShieldCheck, description: 'All our providers are KYC verified for your safety and peace of mind.' },
  { id: 'wc3', title: 'Find Local Experts', icon: MapPin, description: 'Easily discover and connect with skilled professionals in your area.' },
  { id: 'wc4', title: 'Transparent Fee', icon: IndianRupee, description: 'Pay a small one-time fee to unlock contact details. No hidden charges.' },
];
