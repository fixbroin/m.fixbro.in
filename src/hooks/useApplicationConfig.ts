    ...
    const unsubscribe = onSnapshot(configDocRef, (docSnap) => {
      if (docSnap.exists()) {
        ...
        const mergedSettings: AppSettings = {
          ...
          // Merge connection access settings
          connectionAccessOptions: firestoreData.connectionAccessOptions || defaultAppSettings.connectionAccessOptions,
          isFreeAccessFallbackEnabled: typeof firestoreData.isFreeAccessFallbackEnabled === 'boolean' ? firestoreData.isFreeAccessFallbackEnabled : defaultAppSettings.isFreeAccessFallbackEnabled,
          freeAccessDurationMinutes: firestoreData.freeAccessDurationMinutes ?? defaultAppSettings.freeAccessDurationMinutes,
          disclaimerEmailContent: firestoreData.disclaimerEmailContent ?? defaultAppSettings.disclaimerEmailContent,
        };
