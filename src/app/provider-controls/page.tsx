...
import { UserCheck, Settings, ListChecks, Languages, Paperclip, Power, MapPin, HandCoins, Banknote, Handshake, FileText } from "lucide-react";
...
import ConnectionAccessSettingsTab from "@/components/admin/provider-controls/ConnectionAccessSettingsTab";
import ProviderTermsTab from "@/components/admin/provider-controls/ProviderTermsTab";
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="experience_levels" className="w-full">
        <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 lg:grid-cols-10 gap-1 mb-6 h-auto flex-wrap justify-start">
          ...
          <TabsTrigger value="connection_access"><Handshake className="mr-2 h-4 w-4"/>Connection Access</TabsTrigger>
          <TabsTrigger value="provider_terms"><FileText className="mr-2 h-4 w-4"/>Provider T&amp;C</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="connection_access">
          <ConnectionAccessSettingsTab />
        </TabsContent>
         <TabsContent value="provider_terms">
          <ProviderTermsTab />
        </TabsContent>
      </Tabs>
    </div>
