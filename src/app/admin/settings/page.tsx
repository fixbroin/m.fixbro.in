...
import { Settings, Save, Loader2, AlertCircle, MapPin as MapIcon, MailIcon, PlaySquare, Percent, Ban, Users, Clock, DollarSign, CreditCard, ShieldAlert } from "lucide-react";
    ...
    try {
      ...
      if (docSnap.exists()) {
        ...
        const mergedSettings = { 
          ...
          isComplaintSystemEnabled: typeof firestoreData.isComplaintSystemEnabled === 'boolean' ? firestoreData.isComplaintSystemEnabled : defaultAppSettings.isComplaintSystemEnabled, // Merge complaint system setting
        };
        ...
        <TabsContent value="general">
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4 p-4 border rounded-md shadow-sm">
                <h3 className="text-lg font-semibold flex items-center"><ShieldAlert className="mr-2 h-5 w-5 text-muted-foreground"/>Complaint System</h3>
                 <div className="flex items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    <Label htmlFor="isComplaintSystemEnabled" className="text-base">Enable Complaint System</Label>
                    <p className="text-sm text-muted-foreground">
                      Allow users to file complaints against providers from their profile page.
                    </p>
                  </div>
                  <Switch
                    id="isComplaintSystemEnabled"
                    name="isComplaintSystemEnabled" 
                    checked={settings.isComplaintSystemEnabled ?? true}
                    onCheckedChange={(checked) => handleSwitchChange('isComplaintSystemEnabled', checked)}
                    disabled={isSaving}
                  />
                </div>
              </div>
