...
const knownPageSlugs = ["about-us", "contact-us", "careers", "terms-of-service", "privacy-policy", "faq", "provider-terms-conditions", "cancellation-policy"];
const pageDisplayNames: Record<string, string> = {
  ...
  "faq": "FAQ",
  "provider-terms-conditions": "Provider Terms & Conditions",
