...
import {
  ...
  Loader2, Info, FileText, Construction, UserPlus, Users
} from 'lucide-react';
...
function AccountPageContent() {
  ...
  const accountMenuItems = [
    ...
    { href: '/my-bookings', label: 'My Contacts', icon: Users },
  ...
  const policyItems = [
     { href: '/terms-of-service', label: 'Terms and Conditions', icon: FileText },
     
     { href: '/privacy-policy', label: 'Privacy Policy', icon: FileText },
     { href: '/cancellation-policy', label: 'Cancellation Policy', icon: FileText },
     { href: '/provider-terms-conditions', label: 'Provider Terms & Conditions', icon: FileText },
  ];
